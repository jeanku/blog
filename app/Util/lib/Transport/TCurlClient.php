...
namespace App\Util\lib\Transport;

use App\Util\lib\Exception\TTransportException;
use App\Util\lib\Factory\TStringFuncFactory;
...
class TCurlClient extends TTransport
{
    ...
    {
        if (!self::$curlHandle) {
            register_shutdown_function(array('App\Util\lib\\Transport\\TCurlClient', 'closeCurlHandle'));
