...
class HelloServiceClient implements HelloServiceIf {
  ...
  {
    $args = new \App\Thrift\HelloThrift\HelloService_sayHello_args();
    $args->name = $name;
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\App\Thrift\HelloThrift\HelloService_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \App\Thrift\HelloThrift\HelloService_sayHello_result();
...
class HelloServiceProcessor {
  ...
  protected function process_sayHello($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\App\Thrift\HelloThrift\HelloService_sayHello_args', $input->isStrictRead());
    }
    else
    {
      $args = new \App\Thrift\HelloThrift\HelloService_sayHello_args();
